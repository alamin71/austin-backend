...
router.get('/streamer/:streamerId', auth(USER_ROLES.USER, USER_ROLES.VENDOR, USER_ROLES.ADMIN), AnalyticsController.getStreamerDashboard);

// My dashboard (Current user)
router.get('/my-dashboard', auth(USER_ROLES.USER, USER_ROLES.VENDOR), AnalyticsController.getMyDashboard);
...
router.get('/comparison', auth(USER_ROLES.USER, USER_ROLES.VENDOR, USER_ROLES.ADMIN), AnalyticsController.getComparisonAnalytics);
